...
export const metadata: Metadata = {
    title: "Interior Fit-Out Company in UAE | Skyline Décor – Al Namariq Group",
    description: "Skyline Décor is a leading interior fit-out company in the UAE delivering turnkey interior solutions, ceilings, partitions, cladding & renovations for commercial & residential projects.",
    keywords: [
